...
import '../auth/caregiver_auth_service.dart';
...
class _CaregiverPinScreenState extends State<CaregiverPinScreen> {
  ...
  Future<void> _onChanged() async {
    ...
    if (_controller.length != 4) return;

    _isVerifying = true;

    final pin = _controller.entered;

    final isCorrect =
        await CaregiverAuthService.instance.verifyPinForCurrentUser(pin);
